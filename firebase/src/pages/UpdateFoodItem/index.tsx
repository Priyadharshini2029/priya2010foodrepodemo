    ...
    <><Header FoodItems={[]}/>
      <table className="min-w-full table-auto border-collapse border border-gray-300">
        ...
        <thead className="bg-gray-100">
          <tr>
            <th className="px-4 py-2 w-[200px] text-center border border-gray-300">Name</th>
        ...
        <tbody>
          {FoodItems.map((product) => (
            <tr key={product.id}>
              <td className="px-4 py-2 text-center border border-gray-300 font-medium">{product.name}</td>
              ...
              <td className="px-4 py-2 text-center border border-gray-300">
                <button
                  ...
                  className="bg-pink-600 text-white p-2 border w-[50%] border-black rounded-lg hover:bg-pink-400" 
                >
                  Edit
                </button>
              </td>
      ...
      {editingProduct && (
        <form onSubmit={handleUpdateFoodItem} className="mt-4 p-4 border rounded-lg">
          ...
          <button type="submit" className="bg-lime-600 text-white p-2 rounded-md hover:bg-lime-800">Update</button>
        </form>
      )}
      ...
      <div className="flex justify-center w-[600px] items-center p-3">
        {Message && (
          <div className="p-3 bg-purple-950/45">
